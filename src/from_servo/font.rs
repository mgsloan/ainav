// Copied nearly verbatim from https://github.com/servo/webrender/blob/e231f699ceef045595940a8fea76fa3a829491f5/webrender/src/platform/unix/font.rs
// Changes:
//   * Copied api::font module, renamed to font_types

/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */

use font_types::{FontInstance, FontKey, FontRenderMode, GlyphDimensions};
use font_types::{NativeFontHandle, SubpixelDirection};
use font_types::{GlyphKey};
use fast_hash_map::FastHashMap;
